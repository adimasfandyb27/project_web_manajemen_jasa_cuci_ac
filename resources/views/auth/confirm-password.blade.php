            ...
            <div class="w-full max-w-md">
                ...
                <div class="bg-white shadow-xl rounded-2xl border border-gray-100 p-8">
                    ...
                    <div class="mb-6 text-center">
                        ...
                        <h2 class="text-2xl font-bold text-gray-800 tracking-tight">Confirm Password</h2>
                        <p class="text-sm text-gray-500 mt-1">This is a secure area. Please confirm your password before continuing.</p>
                    </div>

                    <form method="POST" action="{{ route('password.confirm') }}" class="space-y-5" x-data="{ loading: false, showPassword: false }" x-on:submit="loading = true">
                        @csrf
