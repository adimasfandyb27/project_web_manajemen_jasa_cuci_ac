                ...
                <div class="bg-white shadow-xl rounded-2xl border border-gray-100 p-8">
                    ...
                    <div class="mb-6 text-center">
                        <div class="w-16 h-16 mx-auto mb-4 rounded-2xl bg-emerald-50 flex items-center justify-center">
                            <svg class="w-8 h-8 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z"/></svg>
                        </div>
                    ...
                    <form method="POST" action="{{ route('password.store') }}" class="space-y-5" x-data="{ loading: false, showPassword: false, showConfirmPassword: false }" x-on:submit="loading = true">
                        @csrf
                        ...
                        <div>
                            ...
                            <div class="relative mt-1">
                                ...
                                <input :type="showConfirmPassword ? 'text' : 'password'" id="password_confirmation" name="password_confirmation" required autocomplete="new-password" placeholder="Confirm new password"
                                    class="block w-full pl-11 pr-12 py-2.5 rounded-xl border-gray-200 focus:border-emerald-500 focus:ring-emerald-500 shadow-sm placeholder:text-gray-400" />
