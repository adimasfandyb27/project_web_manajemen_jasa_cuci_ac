<x-app-layout>
    ...
    <div x-data="serviceOrder()" class="max-w-7xl mx-auto px-4 py-8 space-y-8">
        ...
        <form action="{{ route('admin.service-orders.store') }}" method="POST" class="space-y-8" x-on:submit="loading = true">
            @csrf
                    ...
                    <table class="w-full text-sm">
                        ...
                        <tbody class="divide-y">
                            ...
                            <template x-for="(item,index) in items" :key="index">
                                ...
                                <tr x-transition.duration.300ms class="hover:bg-gray-50 transition">
            ...
            <div class="flex justify-end">
                <button type="submit" :disabled="loading"
                    class="px-6 py-3 rounded-xl bg-emerald-600 hover:bg-emerald-700 disabled:opacity-60 disabled:cursor-not-allowed text-white font-semibold shadow-md transition">
