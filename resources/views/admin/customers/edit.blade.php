<x-app-layout>
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500">
                    Perbarui informasi customer dan unit AC yang dimiliki
                </p>
            </div>
    ...
    <div class="py-10 bg-gray-100 min-h-screen">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form action="{{ route('admin.customers.update', $customer->id) }}" method="POST"
                  x-data="acUnitsForm({{ json_encode($existingUnits) }})">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="nama" value="{{ old('nama', $customer->nama) }}"
                                    class="w-full rounded-xl border-gray-200
                                           focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200" required>
                                @error('nama')
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="alamat" rows="4"
                                    class="w-full rounded-xl border-gray-200
                                           focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200">{{ old('alamat', $customer->alamat) }}</textarea>
                            </div>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden mb-6">
                    ...
                    <div class="px-6 py-4 border-b bg-emerald-50 flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-xs text-emerald-700">
                                Kelola unit AC yang dimiliki pelanggan
                            </p>
                        </div>
    ...
    <script>
        function acUnitsForm(existingUnits = []) {
            return {
                units: existingUnits.length ? existingUnits : [],
                addUnit() {
                    this.units.push({
                        ac_brand_id: '',
                        ac_type_id: '',
