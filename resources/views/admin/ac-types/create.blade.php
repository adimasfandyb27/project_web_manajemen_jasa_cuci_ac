        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">
                    Tambahkan tipe AC baru yang tersedia untuk pelanggan.
                </p>
            </div>
        ...
        <div class="bg-white rounded-2xl border border-emerald-100 shadow-sm overflow-hidden">
            ...
            <div class="px-6 py-4 border-b border-emerald-50">
                ...
                <p class="text-sm text-gray-500">
                    Lengkapi data tipe AC yang akan ditambahkan.
                </p>

            </div>

            <form action="{{ route('admin.ac-types.store') }}" method="POST" class="p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nama" value="{{ old('nama') }}"
                            placeholder="Contoh: Split Wall, Cassette, Floor Standing"
                ...
                <div class="mt-6">
                    ...
                    <textarea name="keterangan" rows="5" placeholder="Masukkan keterangan tipe AC..."
                        class="w-full rounded-xl border border-gray-200
                               px-4 py-3
                               focus:border-emerald-500
