        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">
                    Perbarui informasi merek AC yang tersedia dalam sistem.
                </p>
            </div>
        ...
        <div class="bg-white rounded-2xl border border-emerald-100 shadow-sm overflow-hidden">
            ...
            <div class="px-6 py-4 border-b border-emerald-50">
                ...
                <p class="text-sm text-gray-500">
                    Ubah data merek AC sesuai kebutuhan.
                </p>

            </div>

            <form action="{{ route('admin.ac-brands.update', $brand) }}" method="POST" class="p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" value="{{ $brand->kode }}" readonly
                ...
                <div class="mt-6">
                    ...
                    <textarea name="keterangan" rows="5"
                        class="w-full rounded-xl border border-gray-200
                               px-4 py-3
                               focus:border-emerald-500
                               focus:ring-4 focus:ring-emerald-100">{{ old('keterangan', $brand->keterangan) }}</textarea>
