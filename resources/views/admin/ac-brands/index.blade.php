<x-app-layout>
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">
                    Kelola seluruh merek AC yang tersedia dalam sistem.
                </p>
            </div>

            <a href="{{ route('admin.ac-brands.create') }}"
        ...
        <div class="bg-white rounded-2xl border border-emerald-100 shadow-sm overflow-hidden">
            ...
            <div class="px-6 py-4 border-b border-emerald-50">
                ...
                <p class="text-sm text-gray-500">
                    Seluruh merek AC yang terdaftar.
                </p>
    ...
    @push('scripts')
        <script>
            $(function() {
                $('#acBrandTable').DataTable({
                    processing: true,
                    serverSide: true,
                    language: {
                        processing: "Memuat data..."
                    },
                    ajax: "{{ route('admin.ac-brands.index') }}",
                    columns: [{
                            data: 'DT_RowIndex',
                            name: 'DT_RowIndex',
                            orderable: false,
                    ...
                    language: {
                        searchPlaceholder: "Cari merek AC...",
                        ...
                        emptyTable: "Belum ada data merek AC"
                    }
                });
            });
        </script>
